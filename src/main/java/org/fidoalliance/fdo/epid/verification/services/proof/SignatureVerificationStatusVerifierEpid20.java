...
@Component
class SignatureVerificationStatusVerifierEpid20 extends SignatureVerificationStatusVerifier {

  private static final int SIGRL_VERSION_OFFSET = 16;
  private static final int SIGNATURE_VERSION_OFFSET = 352;
