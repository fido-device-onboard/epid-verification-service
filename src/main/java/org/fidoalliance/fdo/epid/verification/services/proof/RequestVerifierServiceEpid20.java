...
public class RequestVerifierServiceEpid20 extends RequestVerifierService {

  private final SignatureVerificationStatusVerifierEpid20 signatureVerificationStatusVerifier;
  ...
  public void verifyEpidSignature(
    ...
    VerifySignatureStatus status =
        epid_verifier.verify_signature(signature, groupPubKey, msg, sigRl, privRl, basename);
